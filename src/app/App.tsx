...
import type { AppState, AuthMode, Tab, Category, Mood, Visit, Place, DealStatus, Deal, DealsResult } from "../types";
import { CAT, MOOD, PLATFORMS, generateDeals, SEED, buildSeedCalendar, USERS, PIE_COLORS, DAYS, HOURS } from "../data/catalog";
import { brandAvatar, resolvePlaceImage } from "../utils/avatar";
